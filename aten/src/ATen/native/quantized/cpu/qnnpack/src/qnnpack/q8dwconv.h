...
DECLARE_PYTORCH_Q8UPDWCONV_UKERNEL_FUNCTION(pytorch_q8dwconv_ukernel_up8x9__scalar)
DECLARE_PYTORCH_Q8UPDWCONV_UKERNEL_FUNCTION(
...
DECLARE_PYTORCH_Q8MPDWCONV_UKERNEL_FUNCTION(pytorch_q8dwconv_ukernel_mp8x25__scalar)
DECLARE_PYTORCH_Q8MPDWCONV_UKERNEL_FUNCTION(
